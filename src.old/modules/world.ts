...
function randomPokemon(id: number, level: number, bannedMoves: any[] = [], shinyChance = 1, special?: string | undefined, forceMinRarity = 0, forme?: string | null | undefined, strongMoveOnly?: boolean, betterRarityOdds: number = 0): Pokemon {
    const moves = [];
...
export function generateEncounter(location: number, level: number, shinyChance: number = 1, enableEvent: boolean = false, betterRarityOdds: number = 0): Pokemon | Trainer | null {
...
export {
    initializeWorld, getLocation, move, getRegion, getLocations, randomPokemon, getPokemonLocation, generateRarity, randomNature, encounters
};
